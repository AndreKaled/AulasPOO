...
public interface InterfaceGeral {
	...
	default JComponent mudaComp(JComponent componente, Font fonte, Color corFundo, Color corFrente) {
	...
	default JComponent mudaComp(JComponent componente, Font fonte, Color corFundo) {
		componente.setFont(fonte);
		componente.setBackground(corFundo);
		return componente;
	}
	...
	default JComponent mudaComp(JComponent componente, Color corFundo, Color corFrente) {
		componente.setBackground(corFundo);
		componente.setForeground(corFrente);
		return componente;
	}
	...
	default JTextField novaCaixaTxt(int tamanhoFonte, Color corFundo, Color corFrente) {
		JTextField textField = new JTextField();
		textField.setFont(fonte(tamanhoFonte));
		textField.setBackground(corFundo);
		textField.setForeground(corFrente);
	...
	default JButton novoBotao(String nome, Color corFundo, int largura, int altura) {
		JButton botao = new JButton(nome);
		botao.setBackground(corFundo);
		botao.setBounds(0, 0, largura, altura);
		return botao;
	...
	default JButton novoBotao(String nome, Color corFundo, Color corFrente, Font fonte) {
		JButton botao = new JButton(nome);
		botao.setBackground(corFundo);
		botao.setForeground(corFrente);
		botao.setFont(fonte);
	...
	default Rectangle posicionaTxt(JTextField textField, int posicaoX, int posicaoY) {
